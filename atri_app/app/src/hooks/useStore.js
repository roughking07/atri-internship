  ...
  "Home": {
    ...
    "Image2": {
      "custom": {
        ...
        "src": "/app-assets/alexander-hipp-iEEBWgY_6lA-unsplash-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image7": {
      "custom": {
        "alt": "Service1",
        "src": "/app-assets/2203523_arrow_back_botton_left_icon.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image8": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/326568_check_circle_icon.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image9": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/2203522_arrow_botton_next_right_icon.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox124": {
      "custom": {
        "text": "Calfornia State University"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Carousel2": {
      "custom": {
        ...
        "startTile": 1,
        "imageItems": [
          "/app-assets/nattu.jpg",
          "/app-assets/cedric.jpg",
          "/app-assets/ruvim.jpg",
          "/app-assets/mark.jpg",
          "/app-assets/lysander.jpg",
          "/app-assets/luke.jpg"
        ]
      },
      "callbacks": {
    ...
    "Image17": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/marivi-pazos-cvpk5Y4ZWUs-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
